...
INSERT INTO `oci_datalists` VALUES ('installed','1473791407'),('dataroot','/opt/lampp/eLab-data/'),('default_site','1'),('version','2015062900'),('simplecache_enabled','1'),('system_cache_enabled','1'),('simplecache_lastupdate','1473791407'),('processed_upgrades','a:1:{i:0;s:56:\"2015062900-1.11.2-discussion_plugin-e28c7afa4f5f24ec.php\";}'),('admin_registered','1'),('__site_secret__','zS60tZPPWgDoro9aDWIjMYJcTMqM1WZb');
...
INSERT INTO `oci_metadata` VALUES (1,1,1,2,'text',0,2,1473791407,'yes'),(2,36,3,4,'text',36,2,1473791589,'yes'),(3,36,5,4,'text',0,2,1473791589,'yes'),(4,36,6,7,'text',0,2,1473791589,'yes');
...
INSERT INTO `oci_metastrings` VALUES (1,'email'),(2,''),(3,'notification:method:email'),(4,'1'),(5,'validated'),(6,'validated_method'),(7,'admin_user'),(8,'toId'),(9,'36'),(10,'readYet'),(11,'0');
...
INSERT INTO `oci_sites_entity` VALUES (1,'eLab','','http://129.114.110.199/sites/eLab-ss/');
